...
**CRITICAL:** ALL code generated by Claude Code MUST ALWAYS first refer to the relevant documentation in the `/docs` directory. This directory contains project-specific guides, patterns, and conventions that must be followed. Check for relevant docs files before making architectural decisions or implementing features.
